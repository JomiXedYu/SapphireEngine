#ifndef _Sapphire_ASSETS_TEXTURE2D_H
#define _Sapphire_ASSETS_TEXTURE2D_H
...
namespace Sapphire
{
    ...
    {
        CORELIB_DEF_TYPE(Sapphire::Texture2D, AssetObject);
    ...
    {
        CORELIB_DEF_TYPE(Sapphire::Texture2DImporter, AssetImporter);
...
#endif // !_Sapphire_ASSETS_TEXTURE_H
